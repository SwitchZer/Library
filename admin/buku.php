  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <a href="tambah-buku.php" type="button" class="btn btn-primary">Tambah Buku</a>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-12">
        ...
        <tr style = "">
            ...
            <td>
                <a class="badge badge-secondary" href=edit-buku.php?kode=<?php echo $hasil['kode'] ?>>Edit</a> ||
                <a class="badge badge-danger" href=delete-buku.php?kode=<?php echo $hasil['kode'] ?>>Hapus</a>
            </td>
